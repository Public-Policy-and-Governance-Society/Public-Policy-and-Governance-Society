                ...
                $inspiroSlider.each(function() {
                    ...
                    elem.find(".slide").each(function() {
                        if ($(this).hasClass("kenburns")) {
                            ...
                            elemChild.prepend(
                                '<div class="kenburns-bg" style="background-image:url(' + elemChildImage + ')"></div>'
                            );
                        }
                    });
                ...
                $carousel.each(function() {
                    ...
                    if (Number(elem.options.items) !== 1) {
                        if (elem.options.autoWidth || carouselCustomHeightStatus) {
                            ...
                            itemWidth =
                                (elem.options.containerWidth + Number(elem.options.margin)) / setResponsiveColumns;
                            elem.find(".polo-carousel-item").css({
                                width: itemWidth,
                                "padding-right": elem.options.margin + "px",
                            });
            ...
            if ($gridLayout.length > 0) {
                ...
                $gridLayout.each(function() {
                    ...
                    elem.find("." + elem.options.itemSelector).css(
                        "padding",
                        "0 " + elem.options.gridMargin + "px " + elem.options.gridMargin + "px 0"
                    );
            ...
            if ($widget_instagram.length > 0) {
                ...
                $widget_instagram.each(function() {
                    var elem = $(this),
                        ...
                        elem.attr("data-token") || "5783726529.226c7d2.68a168eec1264759b9f91c1fc2c6ce56",
